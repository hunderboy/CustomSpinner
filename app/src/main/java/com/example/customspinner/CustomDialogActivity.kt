...
import com.example.customspinner.fragment.AfterExerciseFragment
...
class CustomDialogActivity : AppCompatActivity() {
    ...
    // 운동 후 다이얼로그
    val afterExerciseFragment = AfterExerciseFragment()
...
//            CustomDialog(context = this).myDig()
        ...
        binding.buttonDialog2.setOnClickListener {
            afterExerciseFragment.show(supportFragmentManager, null)
        }
